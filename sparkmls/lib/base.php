...
class flexmlsConnect {
  ...
  static function admin_menus_init() {
    ...
    //add_submenu_page('edit.php?post_type=page','Add New Neighborhood Page', 'Add Neighborhood', 'manage_options', 'flexmls_connect-add_neighborhood', array('flexmlsConnect', 'neighborhood_page') );
