...
class flexmlsConnectPageSearchResults extends flexmlsConnectPageCore {
    ...
    if(!empty($_GET) && !empty($_GET['alaskaSearch']))
     {
      ...
      }else if(!empty($_GET['alaskaSearch'])){
      ...
      if(!empty($_GET['GarageSpaces']) && $_GET['GarageSpaces'] != 0.00)
      {
      ...
      $search_arr['SavedSearch'] = '20170427164825001017000000';
  ...
  // echo "<pre>"; 
    ...
    elseif ($context == "company") {
      ...
      $cache_time = (strpos($params['_filter'],'ListingCart')!==false) ? 0 : 0;
 ...
 //    echo "<pre>"; print_r($results); die;
  ...
  function quick_search(){
    echo '<form class="search page-menu quick-search-dream" name="property_form" id="list_container_form" method="get">'; 
...
//echo "<pre>"; print_r($area); die;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="?alaskaSearch=advance" style="color:#234c7a;">Advance Search</a>
    ...
    <div class="span2">';
                ...
                echo '</div>
                <div class="span2">
                  <select class="input-block-level quick" name="StandardStatus" id="StandardStatus">';
                  if(!empty($_GET['StandardStatus']))
                  {
                ...
                <div class="span2">
                  <select class="input-block-level quick" name="PropertyType" id="dream_PropertyType">';
                ...
                <div class="span2">
                  <select class="input-block-level quick" name="beds" id="beds">';
                ...
                <div class="span2">
                    <select class="input-block-level quick" name="baths" id="baths">';
                    $baths = array('1+'=>'1','1.5+'=>'1.5+','2+'=>'2','2.5+'=>'2.5','3+'=>'3','4+'=>'4','5+'=>'5','6+'=>'6');   
                      ...
                      // http://alaskadreammakers.info/mat-su-valley/?current_url=http%3A%2F%2Falaskadreammakers.info%2Fmat-su-valley%2F%3Fcurrent_url%3Dhttp%253A%252F%252Falaskadreammakers.info%252Fmat-su-valley%252F%26alaskaSearch%3Dquick%26City%3D%26StandardStatus%3DActive%26PropertyType%3DA%26beds%3D2%26baths%3D2%26min%3D0%26max%3D0%26GarageSpaces%3D0&alaskaSearch=quick&City=&StandardStatus=Active&PropertyType=A&beds=0&baths=0&min=25000&max=10000000&GarageSpaces=0

                      // http://alaskadreammakers.info/idx/search/?SavedSearch=20170427164825001017000000&PropertyType=A&MinPrice=25000&MaxPrice=10000000&StandardStatus=Active&pg=5    
                    echo '</select>
                </div><!--span2-->

                <div class="span2">
                  <select class="input-block-level quick" name="min" id="min2">';
                ...
                <div class="span2 relative">
                  ...
                  <select class="input-block-level quick" name="max" id="max2">';
                ...
                <div class="span2">
                  <select class="input-block-level quick" name="GarageSpaces" id="GarageSpaces">';
