...
class flexmlsConnectPageListingDetails extends flexmlsConnectPageCore {
  ...
  function generate_page($from_shortcode = false) {
    ...
    echo "<div class='flexmls_connect__ld_button_group'>";
      ...
      ?>
        <button id="save-my-list" onclick="saveListing('<?php echo $sf['MlsStatus']; ?>','<?php echo $sf['ListPrice']; ?>','<?php echo get_query_var('ListingId'); ?>','<?php echo get_query_var('fmc_tag'); ?>','<?php echo $current_user->ID; ?>');"><span class="glyphicon glyphicon-heart red"></span>Save listing</button>
      <?php  }  else{  ?>
        <button><a href="#modal-login" data-toggle="ml-modal" id="save-list-login"><span class="glyphicon glyphicon-heart red"></span>Save listing</a></button>
      <?php }  ?>
    ...
    echo "<div class='tabs_wrapper'>"; //tabs wrapper open
    // Tabs
    ...
    $i=0; echo "<pre>"; 
    $details_result = "<div class='panel-group' id='accordions'>";
    $details_result_mob = "<div class='panel-group' id='accordions_mob'>";
    foreach ($this->property_detail_values as $k => $v) { $i++;
      $details_result .= "<div class='flexmls_connect__ld_detail_table panel panel-default'>";
        $details_result .= "<div class='flexmls_connect__detail_header panel-heading'><h4 class='panel-title'><a data-toggle='collapse' data-parent='#accordions' href='#collapseOne{$i}'>{$k}</a></h4></div>";
        $details_result .= "<div class='flexmls_connect__ld_property_detail_body columns2 panel-collapse collapse' id='collapseOne{$i}'>";

        $details_result_mob .= "<div class='flexmls_connect__ld_detail_table panel panel-default'>";
        $details_result_mob .= "<div class='flexmls_connect__detail_header panel-heading'><h4 class='panel-title'><a data-toggle='collapse' data-parent='#accordions' href='#collapseMob{$i}'>{$k}</a></h4></div>";
        $details_result_mob .= "<div class='flexmls_connect__ld_property_detail_body columns2 panel-collapse collapse' id='collapseMob{$i}'>";
          ...
          foreach ($v as $value) {
            ...
            if ($details_count === 1) {
              $details_result .= "<div class='flexmls_connect__ld_property_detail_row'>";
              $details_result_mob .= "<div class='flexmls_connect__ld_property_detail_row'>";
            }
            $details_result .= "<div class='flexmls_connect__ld_property_detail'>{$value}</div>";
            $details_result_mob .= "<div class='flexmls_connect__ld_property_detail'>{$value}</div>";

            if ($details_count === 2) {
              $details_result .= "</div>"; // end row
              $details_result_mob .= "</div>"; // end row
              $details_count = 0;
            }
          }
          if ($details_count === 1) {
            ...
            $details_result .= "</div>";
            $details_result_mob .= "</div>";
          }
        $details_result .= "</div>"; // end details body
        $details_result_mob .= "</div>"; // end details body
      $details_result .= "</div>"; // end details table
      $details_result_mob .= "</div>"; // end details table
    }
    $i++;
    $details_result .= "<div class='flexmls_connect__ld_detail_table panel panel-default'>";
    $details_result_mob .= "<div class='flexmls_connect__ld_detail_table panel panel-default'>";
      $details_result .= "<div class='flexmls_connect__detail_header panel-heading'><h4 class='panel-title'><a data-toggle='collapse' data-parent='#accordions' href='#collapseOne{$i}'>Property Features</a><h4></div>";
      $details_result_mob .= "<div class='flexmls_connect__detail_header panel-heading'><h4 class='panel-title'><a data-toggle='collapse' data-parent='#accordions' href='#collapseMob{$i}'>Property Features</a><h4></div>";
      $details_result .= "<div class='flexmls_connect__ld_property_detail_body panel-collapse collapse' id='collapseOne{$i}'>";
      $details_result_mob .= "<div class='flexmls_connect__ld_property_detail_body panel-collapse collapse' id='collapseMob{$i}'>";
    ...
    if ($sf["Supplement"]) {
      $details_result .= "<div class='flexmls_connect__ld_detail_table panel panel-default'>";
      $details_result_mob .= "<div class='flexmls_connect__ld_detail_table panel panel-default'>";
        $details_result .= "<div class='flexmls_connect__detail_header panel-heading'><h4 class='panel-title'><a data-toggle='collapse' data-parent='#accordions' href='#collapseOne{$i}'>Supplements</a><h4></div>";
        $details_result_mob .= "<div class='flexmls_connect__detail_header panel-heading'><h4 class='panel-title'><a data-toggle='collapse' data-parent='#accordions' href='#collapseMob{$i}'>Supplements</a><h4></div>";
        $details_result .= "<div class='flexmls_connect__ld_property_detail_body panel-collapse collapse' id='collapseOne{$i}'>";
        $details_result_mob .= "<div class='flexmls_connect__ld_property_detail_body panel-collapse collapse' id='collapseMob{$i}'>";
          $details_result .= "<div class='flexmls_connect__ld_property_detail_row'>";
          $details_result_mob .= "<div class='flexmls_connect__ld_property_detail_row'>";
            $details_result .= "<div class='flexmls_connect__ld_property_detail'>{$sf["Supplement"]}</div>";
            $details_result_mob .= "<div class='flexmls_connect__ld_property_detail'>{$sf["Supplement"]}</div>";
          $details_result .= "</div>";
          $details_result_mob .= "</div>";
        $details_result .= "</div>";
        $details_result_mob .= "</div>";
    ...
    if ( count($sf['Rooms'] > 0) ) {
      ...
      if ($room_count) {
        $details_result .= "<div class='panel panel-default'><div class='flexmls_connect__detail_header panel-heading'><h4 class='panel-title'><a data-toggle='collapse' data-parent='#accordions' href='#collapseOne{$i}'>Room Information</a></h4></div>";
        $details_result_mob .= "<div class='panel panel-default'><div class='flexmls_connect__detail_header panel-heading'><h4 class='panel-title'><a data-toggle='collapse' data-parent='#accordions' href='#collapseMob{$i}'>Room Information</a></h4></div>";
        $details_result .= "<div class='flexmls_connect__ld_property_detail_body panel-collapse collapse' id='collapseOne{$i}'><table width='100%'>";
        $details_result_mob .= "<div class='flexmls_connect__ld_property_detail_body panel-collapse collapse' id='collapseMob{$i}'><table width='100%'>";
        $details_result .= "  <tr>";
        $details_result_mob .= "  <tr>";
        foreach ($room_names as $room){
          $details_result .= "    <td><b>{$room}</b></td>";
          $details_result_mob .= "    <td><b>{$room}</b></td>";
        }
        $details_result .= "  </tr>";
        $details_result_mob .= "  </tr>";
        ...
        {
          $details_result .= "  <tr " . ($x % 2 == 0 ? "class='flexmls_connect__sr_zebra_on'" : "") . ">";
          $details_result_mob .= "  <tr " . ($x % 2 == 0 ? "class='flexmls_connect__sr_zebra_on'" : "") . ">";
          for ($i = 0; $i < count($room_values); $i++){
            $details_result .= "<td>{$room_values[$i][$x]}</td>";
            $details_result_mob .= "<td>{$room_values[$i][$x]}</td>";
          }
          $details_result .= "</tr>";
          $details_result_mob .= "</tr>";
        }
        $details_result .= "</table></div>";
        $details_result_mob .= "</table></div>";
      }

      $details_result .= "</div></div>";
      $details_result_mob .= "</div></div>";
      echo $details_result;
    ...
    <div class="panel-group" id="accordion" style="display:none;">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title">
            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"><i class="more-less glyphicon glyphicon-plus" style="left: 90%;  font-size: 15px;"></i>Details</a>
          </h4>
        </div>
        <div id="collapseOne" class="panel-collapse collapse">
          <div class="panel-body">';
          echo $details_result_mob;
          echo '</div>
        </div>';
      if ($sf['Latitude'] && $sf['Longitude'] && $sf['Latitude'] != "********" && $sf['Longitude'] != "********")
      {
        echo '<div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title">
              <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"><i class="more-less glyphicon glyphicon-plus" style="left: 90%;  font-size: 15px;"></i>Maps</a>
            </h4>
          </div>
          <div id="collapseTwo" class="panel-collapse collapse">
            <div class="panel-body">';
            
            echo "<div class='flexmls_connect__tab_group' id=''>
              <div id='flexmls_connect__map_canvas' latitude='{$sf['Latitude']}' longitude='{$sf['Longitude']}'></div>
              </div>";
      ...
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree"><i class="more-less glyphicon glyphicon-plus" style="left: 90%;  font-size: 15px;"></i>Documents</a>
        </h4>
      </div>
      <div id="collapseThree" class="panel-collapse collapse">
        ...
        echo "<div class='flexmls_connect__tab_group'>";
        echo "<div class='flexmls_connect__detail_header'>Listing Documents</div>";
        echo "<table>";
