...
class flexmlsConnectPageListingDetails extends flexmlsConnectPageCore {
  ...
  function generate_page($from_shortcode = false) {
    ...
    echo "<div class='flexmls_connect__ld_button_group'>";
      ...
      <?php  }  else{  ?>
       <a href="#modal-login" data-toggle="ml-modal" id="save-list-login" class="save-list-btn"><span class="glyphicon glyphicon-heart red"></span>Save listing</a>
      <?php } // first, media buttons are on the right
    ...
    foreach ($this->property_detail_values as $k => $v) {
      $details_result .= "<div class='flexmls_connect__ld_detail_table'>";
        $details_result .= "<div class='flexmls_connect__detail_header'>{$k}</div>";
        $details_result .= "<div class='flexmls_connect__ld_property_detail_body columns2'>";
    ...
    $details_result .= "<div class='flexmls_connect__ld_detail_table'>";
      $details_result .= "<div class='flexmls_connect__detail_header'>Property Features</div>";
      $details_result .= "<div class='flexmls_connect__ld_property_detail_body'>";
    ...
    if ($sf["Supplement"]) {
      $details_result .= "<div class='flexmls_connect__ld_detail_table'>";
        $details_result .= "<div class='flexmls_connect__detail_header'>Supplements</div>";
        $details_result .= "<div class='flexmls_connect__ld_property_detail_body'>";
          $details_result .= "<div class='flexmls_connect__ld_property_detail_row'>";
    ...
    if ( count($sf['Rooms'] > 0) ) {
      ...
      if ($room_count) {
        $details_result .= "<div class='flexmls_connect__detail_header'>Room Information</div>";
        $details_result .= "<table width='100%'>";
        $details_result .= "  <tr>";
      ...
      if ($sf['Latitude'] && $sf['Longitude'] && $sf['Latitude'] != "********" && $sf['Longitude'] != "********") {
      $map_data = "<div class='flexmls_connect__tab_group' id='flexmls_connect__map_group'>
    ...
    <div class="panel-group" id="accordion" style="display:none;">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title">
            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse1">Details</a>
          </h4>
        </div>
      ...
      if ($sf['Latitude'] && $sf['Longitude'] && $sf['Latitude'] != "********" && $sf['Longitude'] != "********")
      {
        echo '<div class="panel panel-default">
          <div class="panel-heading">
            <h4 class="panel-title">
              <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse2">Maps</a>
            </h4>
          </div>
      ...
      <div class="panel-heading">
        <h4 class="panel-title">
          <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse3">Documents</a>
        </h4>
      </div>
